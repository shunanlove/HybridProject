...
export class AppComponent {
  ...
  goToBaiduMap() {
    ...
    this.mService.goToBaiduMap(params);
  }
  ...
  goToGaodeMap() {
    ...
    this.mService.goToGaodeMap(params);
  }
  ...
  goToTencentMap() {
    ...
    this.mService.goToTencentMap(params);
  }

  callPhone() {
    this.mService.callPhone('13236903697');
  }
  ...
  shareParameter() {
    ...
    this.mService.shareParameter(params, {
      onSuccess: (res: string) => {
        console.log(res);
      }
    });
